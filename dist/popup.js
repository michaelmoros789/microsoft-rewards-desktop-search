...
const baseUrlTextbox = document.getElementById("baseUrl");
const openBookmarkButton = document.getElementById("openBookmark");
 ...
 */
function updateValidationStatus(url) {
 ...
 */
function replaceQueryParam(url, value) {
 ...
 */
function validateAndSetSkipDuration(value) {
 ...
 */
function validateAndSetBookmarkCount(value) {
    const num = parseInt(value);
 ...
 */
function updateStatusText(bookmarks) {
 ...
 */
function getUniqueWords(number) {
    try {
 ...
 * @param e Input event
 */
function handleBookmarkCountInput(e) {
 ...
 * @param e Blur event
 */
function handleBookmarkCountBlur(e) {
    const target = e.target;
    if (!target.value) {
 ...
 * @param e Input event
 */
function handleSkipDurationInput(e) {
    const target = e.target;
 ...
 * @param e Blur event
 */
function handleSkipDurationBlur(e) {
    const target = e.target;
    if (!target.value) {
 ...
 */
function handleOpenBookmarkClick() {
    if (!state.isBaseUrlValid) {
 ...
 */
function emptyMicrosoftRewardsFolder() {
    return new Promise((resolve, reject) => {
        chrome.bookmarks.search({ title: "Microsoft Rewards" }, (folders) => {
            if (chrome.runtime.lastError) {
                Logger.error('Failed to search for Microsoft Rewards folder:', chrome.runtime.lastError);
 ...
 */
async function createBingSearchBookmarks() {
    return new Promise((resolve, reject) => {
